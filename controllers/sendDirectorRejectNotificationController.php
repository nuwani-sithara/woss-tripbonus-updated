...
try {
    ...
    // Email to OM
    $subject = "Payments Rejected by Director for $month $year";
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <p>The payments for <strong>$month $year</strong> have been <strong>rejected</strong> by Director: <strong>$directorName</strong> on $verifyDate.</p>
    ...
    // Log notification
    $stmt = $conn->prepare("INSERT INTO payment_notifications (publishedID, accountantID, recipientID, recipient_role, notification_type, email_sent, sent_at, reason, status) VALUES (?, ?, ?, 'operation_manager', 'director_reject', 1, NOW(), ?, 1)");
    $stmt->bind_param("iiis", $publishedID, $directorID, $om['userID'], $reason);
    $stmt->execute();
