<?php
require_once('../controllers/supervisorInChargeJobsController.php');

if (!isset($_SESSION['userID']) || !isset($_SESSION['roleID']) || $_SESSION['roleID'] != 13) { // 13 = Supervisor-in-Charge
...
<html lang="en">
  <head>
    ...
    <title>Jobs Overview - SubseaOps</title>
      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">Jobs Overview</h3>
          </div>
                      ...
                      <tbody>
                        <?php foreach ($jobs as $job): ?>
                          <tr>
                            ...
                            <td><?php echo htmlspecialchars($job['jobkey']); ?></td>
